...
_list_of_globals_opa_0_45 := [
	"abs", "all", "and", "any", "array", "assign", "bits", "cast_array", "cast_boolean", "cast_null", "cast_object", "cast_set", "cast_string",
...
_newer_than_opa_0_45 := [
	"json.match_schema", "json.verify_schema", "object.keys", "time.format", "crypto.hmac.equal", "crypto.x509.parse_keypair",
